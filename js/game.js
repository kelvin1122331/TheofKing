...
import { chooseMove, evaluateFor, AI_NAMES } from './ai.js?v=10';
import { sfx } from './sound.js?v=10';
import { store, saveStats, pushRecent } from './store.js?v=10';
import { applyResult, rankForStars } from './ranks.js?v=10';
import {
  $, avatarHTML, fmtClock, toast, openModal, closeModal,
  confettiBurst, esc, confirmDialog,
} from './ui.js?v=10';
import { pieceSrc } from './pieces.js?v=10';
import { flagFor } from './countries.js?v=10';
import { applySkin, skinById } from './skins.js?v=10';
