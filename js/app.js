...
// ============================================================
import { store, saveStats, validateProfile, PRESET_AVATARS, getLeaderboard, myGlobalRank, avatarGradientFor, initialsFor, makePlayerId, addFriend, removeFriend } from './store.js?v=26';
import { rankForStars, rankProgress, RANKS, STARS_PER_RANK } from './ranks.js?v=26';
import { sfx, unlockAudio, soundEnabled, setSoundEnabled } from './sound.js?v=26';
import { $, $$, esc, openModal, closeModal, toast, confirmDialog, initConfirm, copyText, avatarHTML, starRowHTML, renderMiniBoard, fmtTimeAgo, showVsSplash, nickHTML, borderOverlayHTML, confettiBurst } from './ui.js?v=26';
import { Net, peerErrorMessage, arenaCodeFor, ARENA_BUCKET_MS } from './net.js?v=26';
import { Server, isServerOnline, isServerReadonly, setServerReadonly, checkServer, openMatchSocket } from './server.js?v=26';
import { Game } from './game.js?v=26';
import { preloadPieces } from './pieces.js?v=26';
import { AI_LEVELS, AI_NAMES, chooseMove } from './ai.js?v=26';
import { COUNTRIES, countryByCode, flagEmoji, flagFor } from './countries.js?v=26';
import { SKINS, skinById, applySkin } from './skins.js?v=26';
import { BORDERS, AVATARS, NICKFX, borderById, avatarById, avatarImg, nickFxById } from './cosmetics.js?v=26';
