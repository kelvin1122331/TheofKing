...
export const sfx = {
  ...
  buy()     { tone({ freq: 1320, dur: 0.09, type: 'triangle', vol: 0.2 }); tone({ freq: 1760, dur: 0.14, type: 'triangle', vol: 0.2, delay: 0.08 }); tone({ freq: 2093, dur: 0.2, type: 'triangle', vol: 0.18, delay: 0.16 }); },
};
